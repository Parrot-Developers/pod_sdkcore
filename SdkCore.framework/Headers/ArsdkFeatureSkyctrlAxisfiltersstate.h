...
*/
- (void)onCurrentAxisFilters:(NSInteger)axisId filterUidOrBuilder:(nonnull NSString *)filterUidOrBuilder
...
*/
- (void)onPresetAxisFilters:(nonnull NSString *)filterUid name:(nonnull NSString *)name
...
+ (NSInteger)decode:(nonnull struct arsdk_cmd *)command callback:(nonnull id<ArsdkFeatureSkyctrlAxisfiltersstateCallback>)callback;
