...
*/
- (void)onWifiScanListChanged:(nonnull NSString *)ssid rssi:(NSInteger)rssi band:(ArsdkFeatureArdrone3NetworkstateWifiscanlistchangedBand)band channel:(NSUInteger)channel
...
+ (NSInteger)decode:(nonnull struct arsdk_cmd *)command callback:(nonnull id<ArsdkFeatureArdrone3NetworkstateCallback>)callback;
