...
*/
- (void)onCurrentButtonMappings:(NSInteger)keyId mappingUid:(nonnull NSString *)mappingUid
...
*/
- (void)onAvailableButtonMappings:(nonnull NSString *)mappingUid name:(nonnull NSString *)name
...
+ (NSInteger)decode:(nonnull struct arsdk_cmd *)command callback:(nonnull id<ArsdkFeatureSkyctrlButtonmappingsstateCallback>)callback;
