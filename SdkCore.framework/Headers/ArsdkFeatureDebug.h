...
*/
- (void)onSettingsInfo:(NSUInteger)listFlagsBitField id:(NSUInteger)id label:(nonnull NSString *)label type:(ArsdkFeatureDebugSettingType)type mode:(ArsdkFeatureDebugSettingMode)mode rangeMin:(nonnull NSString *)rangeMin rangeMax:(nonnull NSString *)rangeMax rangeStep:(nonnull NSString *)rangeStep value:(nonnull NSString *)value
...
/**
 ...
 - parameter id: id of debug tag as generated by the drone
*/
- (void)onTagNotify:(nonnull NSString *)id
NS_SWIFT_NAME(onTagNotify(id:));
...
+ (NSInteger)decode:(nonnull struct arsdk_cmd *)command callback:(nonnull id<ArsdkFeatureDebugCallback>)callback;
...
/**
 ...
 - parameter value: tag value (single line).
 - returns: a block that encodes the command
*/
+ (int (^ _Nonnull)(struct arsdk_cmd * _Nonnull))tagEncoder:(nonnull NSString *)value
NS_SWIFT_NAME(tagEncoder(value:));
