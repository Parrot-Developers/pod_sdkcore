...
/**
 ...
 - parameter keyType: 
*/
- (void)onWifiSecurity:(ArsdkFeatureArdrone3NetworksettingsstateWifisecurityType)type key:(nonnull NSString *)key keytype:(ArsdkFeatureArdrone3NetworksettingsstateWifisecurityKeytype)keytype
...
+ (NSInteger)decode:(nonnull struct arsdk_cmd *)command callback:(nonnull id<ArsdkFeatureArdrone3NetworksettingsstateCallback>)callback;
