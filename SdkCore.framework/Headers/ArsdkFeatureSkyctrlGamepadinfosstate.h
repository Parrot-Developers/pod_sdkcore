...
*/
- (void)onGamepadControl:(ArsdkFeatureSkyctrlGamepadinfosstateGamepadcontrolType)type id:(NSInteger)id name:(nonnull NSString *)name
...
+ (NSInteger)decode:(nonnull struct arsdk_cmd *)command callback:(nonnull id<ArsdkFeatureSkyctrlGamepadinfosstateCallback>)callback;
